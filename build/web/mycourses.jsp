    ...
    <body>
                            ...
                            <div class="room-item">
                                ...
                                <div class="ri-text">
                                    ...
                                    <div class="text-center pt-5">
                                        ...
                                        <c:forEach items="${listCourseProgress}" var="progressEntry">
                                            ...
                                            <c:if test="${courses.getCourseId() eq progress.getCourseId()}">
                                                <c:if test="${Math.floor(progressValue) eq '100.0'}">
                                                    <a href="certificatedisplay?courseId=${courses.getCourseId()}" class="btn btn-primary" style="background: #dfa974; border: 0" >Get certificate</a>
                                                </c:if>
                                                <c:if test="${Math.floor(progressValue) ne '100.0'}">
                                                    <a href="learn?id=${courses.getCourseId()}" class="btn btn-primary" style="background: #dfa974; border: 0">Start Learning</a>
                                                </c:if>
                                            </c:if>
                                        ...
                                        <c:if test="${courses.checkFeedback(sessionScope.User.getUsername())}">
                                            <button onclick="getId(${courses.getCourseId()})" type="button" class="btn btn-primary" style="background: #dfa974; border: 0" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                Give feedback
                                            </button>
                                        </c:if>
                                        ...
                                        <c:if test="${!courses.checkFeedback(sessionScope.User.getUsername())}">
                                            <button onclick="display(${courses.getCourseId()})" type="button" class="btn btn-primary" style="background: #dfa974; border: 0">
                                                View feedback
                                            </button>
                                        </c:if>
                    ...
                    <div class="col-lg-12">
                        <div class="room-pagination">
                            <c:if test="${index ne 1}">
                                <a href="mycourses?index=${index -1}">Previous <i class="fa fa-long-arrow-left"></i></a>
                                </c:if>
                                <c:forEach begin="1" end="${requestScope.endPage}" var="page">
                                <a href="mycourses?index=${page}" ${page == index ? 'style="background-color: #DFA974; color: white"' : ''}>${page}</a>
                            </c:forEach>
                            <c:if test="${index ne endPage}">
                                <a href="mycourses?index=${index + 1}">Next <i class="fa fa-long-arrow-right"></i></a>
                                </c:if>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-body">
                        <div class="text-center">
                            ...
                            <div class="review-add">
                                <h4>Your Review</h4>
                                <h5>How was your experience</h5>
                                <form id="ratting2" action="rating" class="ra-form">
                                    <input id="id2" type="hidden" name="id" value="${feedback.getCourseId()}">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <br>
                                            <textarea placeholder="Your Review" name="content">${feedback.getFeedback()}</textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <script type="text/javascript">
            function getId(id) {
                ...
                var inputId2 = document.getElementById('id2');
                console.log(id);
                inputId.value = id;
                inputId2.value = id;
            }
