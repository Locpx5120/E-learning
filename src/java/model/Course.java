...
public class Course {
    ...
    public List<Tag> getListTagVerTwo() {
        return new TagDAO().getListTagByCourseID(courseId);
    }
    ...
    public boolean checkFeedback(String username) {
        return new CourseDAO().isFeedbackNullForCourse(courseId, username);
    }
