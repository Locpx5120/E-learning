...
public class UserDAO extends DBContext {
    ...
    public void updateUserProfilebyEmail(String fullname, String dob, String gender, String description, String email, String imgUrl) {
        ...
        try {
            ...
            System.out.println(dob + " - " + imgUrl + " - " + email);
    ...
    public ArrayList<User> getAllUser() {
        ArrayList<User> listLecturer = new ArrayList<>();
        try {
            String sql = "SELECT * FROM [users] WHERE role != 3 and role != 0";
            PreparedStatement ps = connection.prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            ...
            while (rs.next()) {
                ...
                int status = rs.getInt(10);
                User user = new User(username, fname, email, dob, gender, description, status, img);
                user.setRole(role);
                listLecturer.add(user);
            }
        } catch (SQLException e) {
            System.out.println("getListLecturer: " + e.getMessage());
        }
    ...
    public boolean createLecturerAccount(String username, String fullname, String email, String password, String dob, int gender, String description, String role) {
        ...
        try {
            ...
            pstm.setString(8, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNL_ZnOTpXSvhf1UaK7beHey2BX42U6solRA&usqp=CAU");
    ...
    public void updateUserRole(String role, String uaername) {
        // Updated update query
        String updateQuery = "UPDATE users SET role = ? WHERE username = ?";

        // Execute the update query with the new role and user_id
        try ( PreparedStatement preparedStatement = connection.prepareStatement(updateQuery)) {

            preparedStatement.setString(1, role);
            preparedStatement.setString(2, uaername);
